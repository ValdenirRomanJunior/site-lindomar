...
const PseudoSearch = () =>{
   ...
   function selectedAfterGoalSale(e:any){
    ...
    const getAllAddress = async () => {
        const data = await getTAllAddressRequest();
    ...
    return(
        <PseudoSearchContainer className="container"> 
            ...
            <input placeholder="Estado, Cidade, Tipo, Finalidade..." type="text" className="input-search-desktop"  onKeyUp={onKeyUp} value={name} onChange={(e)=>setSearch(e.target.value)}/>
