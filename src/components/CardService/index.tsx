...
const CardService = () => {
    ...
    <CardContainer focus={focusButtonFirst} focusSecond={focusButtonSecond} focusTertiary={focusButtonTertiary}>
        ...
        <div className="buttons-wrapper-service">
            ...
            <button className="button-service-tertiary" onClick={handleFocusButtonTertiary}>Consultoria</button>
        ...
        <LazyLoadImage effect='opacity' loading="eager" src={ImgIconTicket} alt="" className="icon-header-card-service"/>  
            <h1>Consultoria sobre diversos assuntos</h1>           
        </div>
        <p className="subtitle-card-service">Caso queira ajuda profissional, também poderá agendar uma consultoria conosco.</p>
